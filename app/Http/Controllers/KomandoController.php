...
class KomandoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('master.komando.index');
    }

    public function get_list(Request $request){
        $angkatan = Angkatan::where("level","kom")->with('provinsi','parent')->latest()->get();
    ...
    public function store(Request $request)
    {
        ...
        $requestData["level"]="kom";
        Angkatan::create($requestData);
        return response()->json(["error"=>false,"message"=>"Successfuly Added Komando!"]);
    ...
    public function update(Request $request, $id)
    {
        ...
        if($role){
            ...
            return response()->json(["error"=>false,"message"=>"Successfully Update Komando"]);
    ...
    public function destroy($id)
    {
        ...
        return response()->json(["error"=>false,"message"=>"Successfuly Deleted Komando!"]);

    }

    public function select($parent=null)
    {
        $list_all = ($parent) ? Angkatan::where("level","kom")->where("parent",$parent)->get() : Angkatan::where("level","kom")->get();
