            ...
            <div class="content-header row">
                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Master Data Komando</h2>
                        </div>
                    </div>
                </div>
                <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#modal-form"><i data-feather="plus"></i> Komando</button>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="modal_title">Create New Komando</h4>
...
<script>
    $(document).ready(function(){
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $("#parent").select2({ data: result.data });
    ...
    Array.prototype.filter.call($('#form_data'), function (form) {
      form.addEventListener('submit', function (event) {
        ...
        var url = ( id_angkatan !== undefined && id_angkatan !== null && id_angkatan) ? "{{url('master/komando/update')}}"+"/"+id_angkatan : "{{url('master/komando/store')}}";
