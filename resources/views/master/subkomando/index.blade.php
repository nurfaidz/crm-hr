...
<script>
    ...
    Array.prototype.filter.call($('#form_data'), function (form) {
      form.addEventListener('submit', function (event) {
        ...
        var url = ( id_angkatan !== undefined && id_angkatan !== null && id_angkatan) ? "{{url('master/subkomando/update')}}"+"/"+id_angkatan : "{{url('master/subkomando/store')}}";
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $("#modal_title").html("Create New Sub Komando")
                $("#id_angkatan").val()
