            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="float-left mb-0">Edit User</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="content-body">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ url('/users/update/' . $user->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
