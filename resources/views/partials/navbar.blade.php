        ...
        <div class="row align-items-center m-auto">
            <div class="col-xl-8 col-lg-8 col-md-10 col-sm-10 col-8 p-0">
                <div class="col-12 align-items-center m-auto">
                    <div class="row">
                        <div class="col-lg-1 col-md-1 col-sm-1 col-1 d-xl-none m-auto px-0">
                            <a class=" menu-toggle" href="javascript:void(0);"><img src="/img/icons/hamburger.svg"
                                    alt="hamburger"></a>
                        </div>
                        <div
                            class="col-xl-12 col-lg-11 col-md-11 col-sm-11 col-11 bg-white m-auto px-0 shadow rounded-lg">
