                    ...
                    <div class="bs-stepper horizontal-wizard-example">
                        ...
                        <div class="bs-stepper-header">
                            ...
                            <div class="step">
                                <button type="button"
                                    ...
                                    <span class="bs-stepper-label">
                                        <span class="bs-stepper-title first-bst active-bs-stepper-title">Higher-Up
                                            Approval</span>
                                    </span>
                                </button>
                            </div>
                            ...
                            <div class="step">
                                <button type="button" class="step-trigger first-st medical-step-trigger">
                                    ...
                                    <span class="bs-stepper-label">
                                        <span class="bs-stepper-title first-bst">HR Approval</span>
                                    </span>
                                </button>
                            </div>
                            <span class="first-middle-line"></span>
                        ...
                        <div class="card-footer">
                            <div class="text-right pr-1 leave-details-buttons">
                                ...
                                @can('medical_reimbursement_approval.reject_manager')
                                ...
                                @endcan
                                @can('medical_reimbursement_approval.approve_manager')
        ...
        const ApproveAction = (e) => {
            swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: `${base_url}/${id}/approve-manager`,
                        type: 'PUT',
                        headers: {
                ...
                $('#submit').unbind().on('click', (event) => {
                    ...
                    swal.fire({
                        ...
                        if (result.value) {
                            ...
                            const id = e.attr('data-id');
                            $.ajax({
                                url: `${base_url}/${id}/reject-manager`,
                                method: 'PUT',
