                ...
                <section class="horizontal-wizard">
                    <div class="bs-stepper horizontal-wizard-example">
                        ...
                        <div class="bs-stepper-header">
                            ...
                            <div class="step">
                                <button type="button" class="step-trigger first-st {{ $approve1 }}-step-trigger">
                            ...
                            <div id="leave-approved-by">
                                @php
                                    if ($approve1 === 'disable') {
                                        ...
                                        echo "<span>$approval->first_name $approval->last_name</span>";
                                    } elseif ($approve1 === 'done') {
                                        echo '<p>Approved By</p>';
                                        echo "<span>$approval->first_name $approval->last_name</span>";
                                    } elseif ($approve1 === 'danger') {
                            ...
                            <div id="leave-details-information">
                                <div class="row">
                                    ...
                                    <div class="col-6 leave-application">
                                        ...
                                        <div>Type of Leave : {{ $leaveType->leave_type_name }}</div>
                                        @php
                                        ...
                                        @endphp
                                        <div>Start Date :
                                            {{ \Carbon\Carbon::parse($leaveApplication->application_from_date)->format('d/m/Y') }}
                                        </div>
                                        <div>End Date :
                                            {{ \Carbon\Carbon::parse($leaveApplication->application_to_date)->format('d/m/Y') }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        @if ($leaveApplication->leave_type_id == 1 || $leaveApplication->leave_type_id == 2)
                                            <div class="col-4 text-center">
                                                <div class="text-left d-inline-block">
                                                    @if ($leaveApplication->leave_type_id == 1)
                                                        ...
                                                        <span class="text-primary">{{ $leaveApplication->balance }}
                                                            Days</span>
                                                        ...
                                                        <div class="custom-annual-leave">
                                                            <div class="d-flex justify-content-between">
                                                                @if ($leavePeriod)
                                                                    <div>
                                                                        {{ date('d F Y', strtotime($leavePeriod->from_date)) }}
                                                                        -
                                                                        {{ date('d F Y', strtotime($leavePeriod->expired_date)) }}
                                                                    </div>
                                                                @endif
                                                                <div></div>
                                                            </div>
                                            ...
                                            <div class="col-4 text-center">
                                                <div class="text-left d-inline-block">
                                                    ...
                                                    <span class="text-primary">{{ $leaveApplication->number_of_day }}
                                                        Days</span>
                                                    <div class="period-label">PERIODE</div>
                                                    @if ($leavePeriod)
                                                        <div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <textarea name="notes" id="notes" cols="30" rows="5" class="form-control bg-white"
                                            placeholder="{{ $leaveApplication->notes }}" disabled></textarea>
                                    </div>
                                </div>
                            </div>
