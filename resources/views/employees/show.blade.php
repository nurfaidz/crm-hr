                                                ...
                                                <div class="d-flex flex-column align-items-center mt-2">
                                                    ...
                                                    <div class="d-flex">
                                                        <a target="_blank" type="button" class="btn btn-light border"
                                                            href="https://wa.me/{{ $profile->phone }}">Whatsapp</a>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 px-2">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-8">
                                                                        @if (isset($profile->instagram_link))
                                                                            <a target="#blank"
                                                                                href="https://www.instagram.com/{{ $profile->instagram_link }}">{{ $profile->instagram_link }}</a>
                                                                        @else
                                                                            <p>-</p>
                                                                        @endif
                                                                    ...
                                                                    <div class="col-8">
                                                                        @if (isset($profile->linkedin_link))
                                                                            <a target="#blank"
                                                                                href="https://linkedin.com/{{ $profile->linkedin_link }}">{{ $profile->linkedin_link }}</a>
                                                                        @else
                                                                            <p>-</p>
                                                                        @endif
                                                                    </div>
                                                                    ...
                                                                    <div class="col-8">
                                                                        @if (isset($profile->facebook_link))
                                                                            <a target="#blank"
                                                                                href="https://www.facebook.com/{{ $profile->facebook_link }}">{{ $profile->facebook_link }}</a>
                                                                        @else
                                                                            <p>-</p>
                                                                        @endif
                                                                    </div>
                                                ...
                                                <div class="d-flex flex-column align-items-center mt-2">
                                                    <div class="col-12 mt-1">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-7">
                                                                <p>
                                                                    {{ date('j F Y', strtotime($profile->date_of_birth)) }}
                                                                </p>
                                                            </div>
                                                            <!-- End Date of Birth -->
                                                ...
                                                <div class="d-flex flex-column align-items-center mt-2">
                                                    <div class="col-12 mt-1">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-7">
                                                                <p>
                                                                    {{ isset(Auth::user()->roles[0]->name) ? Auth::user()->roles[0]->name : '' }}
                                                                </p>
                                                            </div>
                                                            <!-- End App Status / Role-->
                                                        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <select class="form-control" name="degree" id="degree">
                                ...
                                <option value="Postsecondary Non-Tertiary Education">Postsecondary Non-Tertiary
                                    Education
                                </option>
                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-6">
                                ...
                                <div class="invalid-feedback graduation_year_error">Please enter a graduation year.
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-10 d-flex justify-content-end flex-column">
                                <div>
                                    ...
                                    <button class="btn btn-outline-primary" type="submit"
                                        id="btnImageProfile">Reset</button><br>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" placeholder="Exm: PT persadaInput Job Level Name"
                                        name="email" id="email" required class="form-control" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-12 mb-1">
                                    ...
                                    <div class="invalid-feedback employment_status_id_error">Please enter the
                                        employment
                                        status.</div>
                                </div>
                                <div class="col-lg-6 col-12 mb-1">
                                    ...
                                    <div class="invalid-feedback date_of_joining_error">Please enter a join date.
                                    </div>
                                </div>
                            </div>
                        </div>
...
@section('page_script')
    <script>
        ...
        $(document).on('click', '#edit-additional-information', async function(event) {
            ...
            const blood_type = document.querySelector('#blood_type');
            const religion_id = document.querySelector('#religion_id');
            const nationality = document.querySelector('#nationality');
            const marital_status_id = document.querySelector('#marital_status_id');
            ...
            await fetch(`/employee-additional-information/${id}/edit`)
                .then(response => response.json())
                .then(response => {
                    nik.value = response.nik;
                    passport.value = response.passport;
                    place_of_birth.value = response.place_of_birth;
                    date_of_birth.value = response.date_of_birth;
                    blood_type.value = response.blood_type;
                    nationality.value = response.nationality;
                    address.value = response.address;
                    marital.value = response.marital;
                    religions.value = response.religions;
                });
        ...
        $(document).on('click', '#edit-profile', async function(event) {
            ...
            await fetch(`/profile/${id}/edit`)
                ...
                .then(response => {
                    ...
                    instagram_link.value = response.instagram_link;
                    linkedin_link.value = response.linkedin_link;
